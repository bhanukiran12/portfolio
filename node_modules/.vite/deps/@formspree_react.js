import { i as __toESM, n as __commonJS, t as require_react } from "./react-5eFYziw5.js";

//#region node_modules/@stripe/react-stripe-js/dist/react-stripe.umd.js
var require_react_stripe_umd = /* @__PURE__ */ __commonJS({ "node_modules/@stripe/react-stripe-js/dist/react-stripe.umd.js": ((exports, module) => {
...
//#endregion
//#region node_modules/@formspree/core/dist/index.js
var require_dist = /* @__PURE__ */ __commonJS({ "node_modules/@formspree/core/dist/index.js": ((exports, module) => {
	var g = Object.defineProperty;
	var j$1 = Object.getOwnPropertyDescriptor;
	var V$1 = Object.getOwnPropertyNames;
	...
	var Y$1 = (e, r) => {
		...
		if (r && typeof r == "object" || typeof r == "function") for (let s of V$1(r)) !L.call(e, s) && s !== t && g(e, s, {
			get: () => r[s],
			enumerable: !(o = j$1(r, s)) || o.enumerable
		});
		return e;
	};
	var $$1 = (e) => K$1(g({}, "__esModule", { value: !0 }), e);
	var h$1 = (e, r, t) => new Promise((o, s) => {
		var i = (a) => {
			try {
				l(t.next(a));
			} catch (m) {
	...
	Y$1(W$1, {
		...
		appendExtraData: () => E$1,
		createClient: () => R$1,
		getDefaultClient: () => U$1,
		isSubmissionError: () => A$1
	});
	module.exports = $$1(W$1);
	var u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", J$1 = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/;
	function I$1(e) {
		e = String(e);
	...
	function O(e) {
		if (e = String(e).replace(/[\t\n\f\r ]+/g, ""), !J$1.test(e)) throw new TypeError("Failed to execute 'atob' on 'Window': The string to be decoded is not correctly encoded.");
	...
	var G$1 = () => navigator.webdriver || !!document.documentElement.getAttribute(O("d2ViZHJpdmVy")) || !!window.callPhantom || !!window._phantom, y$1 = class {
		constructor() {
			this.loadedAt = Date.now(), this.webdriver = G$1();
		}
		data() {
			return {
			...
			for (let o of r) {
				if (!o.field) {
					this.formErrors.push({
						code: o.code && z$1(o.code) ? o.code : "UNSPECIFIED",
						message: o.message
					});
					continue;
				}
	...
	var D$1 = "4.0.0";
	var v$1 = (e) => I$1(JSON.stringify(e)), N$1 = (e) => {
		let r = `@formspree/core@${D$1}`;
		return e ? `${e} ${r}` : r;
	};
	function E$1(e, r, t) {
	...
	var C$1 = class {
		constructor(r = {}) {
			this.project = r.project, this.stripe = r.stripe, typeof window != "undefined" && (this.session = new y$1());
		}
		submitForm(s, i) {
			return h$1(this, arguments, function* (r, t, o = {}) {
				let c = o.endpoint || "https://formspree.io", l = this.project ? `${c}/p/${this.project}/f/${r}` : `${c}/f/${r}`, a = {
					Accept: "application/json",
					"Formspree-Client": N$1(o.clientName)
				};
				this.session && (a["Formspree-Session-Data"] = v$1(this.session.data())), t instanceof FormData || (a["Content-Type"] = "application/json");
				function m(f$1) {
					return h$1(this, null, function* () {
						try {
							let n = yield (yield fetch(l, {
								method: "POST",
								mode: "cors",
								body: f$1 instanceof FormData ? f$1 : JSON.stringify(f$1),
								headers: a
							})).json();
							if (M$1(n)) {
								if (P$1(n)) return Array.isArray(n.errors) ? new p(...n.errors) : new p({ message: n.error });
								if (_$1(n)) return new b$1(n.stripe.paymentIntentClientSecret, n.resubmitKey);
								if (w$1(n)) return new S$1({ next: n.next });
							}
							return new p({ message: "Unexpected response format" });
						} catch (d) {
							return new p({ message: d instanceof Error ? d.message : `Unknown error while posting to Formspree: ${JSON.stringify(d)}` });
						}
					});
				}
				if (this.stripe && o.createPaymentMethod) {
					let f$1 = yield o.createPaymentMethod();
					if (f$1.error) return new p({
						code: "STRIPE_CLIENT_ERROR",
						field: "paymentMethod",
						message: "Error creating payment method"
					});
					E$1(t, "paymentMethod", f$1.paymentMethod.id);
					let d = yield m(t);
					...
					if (d.kind === "stripePluginPending") {
						...
						t instanceof FormData ? t.delete("paymentMethod") : delete t.paymentMethod, E$1(t, "paymentIntent", n.paymentIntent.id), E$1(t, "resubmitKey", d.resubmitKey);
						let x = yield m(t);
						return k$1(x), x;
					}
					return d;
	...
	var R$1 = (e) => new C$1(e), U$1 = () => (F$1 || (F$1 = R$1()), F$1), F$1;
}) });

//#endregion
//#region node_modules/@stripe/stripe-js/dist/pure.js
var require_pure$1 = /* @__PURE__ */ __commonJS({ "node_modules/@stripe/stripe-js/dist/pure.js": ((exports) => {
	...
	var runtimeVersionToUrlVersion = function runtimeVersionToUrlVersion$1(version) {
	...
	var injectScript = function injectScript$1(params) {
	...
	var loadScript = function loadScript$1(params) {
	...
	var validateLoadParams = function validateLoadParams$1(params) {
...
var require_pure = /* @__PURE__ */ __commonJS({ "node_modules/@stripe/stripe-js/pure/index.js": ((exports, module) => {
	module.exports = require_pure$1();
}) });

//#endregion
//#region node_modules/@formspree/react/dist/index.mjs
var import_react_stripe_umd = require_react_stripe_umd();
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_dist = require_dist();
var import_react_stripe_umd$1 = require_react_stripe_umd();
var import_pure = require_pure();
var import_react_stripe_umd$2 = require_react_stripe_umd();
var import_dist$1 = require_dist();
var import_dist$2 = require_dist();
var import_react_stripe_umd$3 = require_react_stripe_umd();
function V(e) {
...
function P(e) {
	let { children: t } = e, r = (0, import_react_stripe_umd$2.useElements)();
	return import_react.createElement(E.Provider, { value: { elements: r } }, t);
}
function v() {
...
function N(e) {
	let { children: t, project: r, stripePK: o } = e, [s, n] = (0, import_react.useState)((0, import_dist.createClient)({ project: r })), a = (0, import_react.useMemo)(() => o ? (0, import_pure.loadStripe)(o) : null, [o]);
	return (0, import_react.useEffect)(() => {
		let i = !0;
		return i && n((l) => l.project !== r ? (0, import_dist.createClient)({
			...l,
			project: r
		}) : l), () => {
			i = !1;
		...
		let i = !0;
		return a?.then((l) => {
			i && l && n((p$1) => (0, import_dist.createClient)({
				...p$1,
				stripe: l
			}));
		}), () => {
	...
	}, [a]), import_react.createElement(h.Provider, { value: { client: s } }, a ? import_react.createElement(import_react_stripe_umd$1.Elements, { stripe: a }, import_react.createElement(P, null, t)) : t);
}
function b() {
...
function F(e, t = {}) {
	...
	return async function(p$1) {
		let m = I(p$1) ? $(p$1) : p$1;
		if (typeof s == "object") for (let [u$1, g$1] of Object.entries(s)) {
			let d;
			typeof g$1 == "function" ? d = await g$1() : d = g$1, d !== void 0 && (0, import_dist$2.appendExtraData)(m, u$1, d);
		}
		let c = a?.getElement(import_react_stripe_umd$3.CardElement), x = i && c ? () => i.createPaymentMethod({
			type: "card",
			card: c,
			billing_details: G(m)
		}) : void 0;
...
function J(e, t = {}) {
	let [r, o] = (0, import_react.useState)(null), [s, n] = (0, import_react.useState)(null), [a, i] = (0, import_react.useState)(!1), [l, p$1] = (0, import_react.useState)(!1);
	...
	return [
		...
		async function(x) {
			i(!0);
			let u$1 = await m(x);
			i(!1), (0, import_dist$1.isSubmissionError)(u$1) ? (o(u$1), p$1(!1)) : (o(null), n(u$1), p$1(!0));
		},
		function() {
			o(null), n(null), i(!1), p$1(!1);
		}
	];
}

//#endregion
var Ee = import_react_stripe_umd.CardElement;
export { Ee as CardElement, N as FormspreeProvider, V as ValidationError, J as useForm, b as useFormspree, F as useSubmit };
